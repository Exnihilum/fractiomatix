...
public class MiscMath {
	...
	public static double[] findLinearPartialF(double[] xdata, double[] ydata, int plength) {
		...
		// this array holds (x, b0, b1) triples: start of sequence, bias, factor
	...
	// to get a value interpolated from these functions, which lie in a series, defined by the (b0, b1) bias + factor values
	...
	public static void main(String[] args) {
		...
		ElevatorMovement elevator1m = new ElevatorMovement(10, 14, 20, 24.3);
		...
		if (!drawchart) {
			...
			// sample best-fit linear function findLinearF()

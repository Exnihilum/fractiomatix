...
public class CSRMatrix extends Matrix {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	//			CSR MATRIX DEFINITIONS AND OPERATIONS														//
	//			Leonard Krylov 2016																			//
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public CSRMatrix clone() {
		CSRMatrix A = (CSRMatrix)super.clone();					// will first call Matrix superclass clone() method
	...
	// method converts input matrix A into a CSRMatrix
	public static CSRMatrix convert(Matrix A) {
		return new CSRMatrix(A.name, A.M, A.N, A.getData()[0], A.getData()[1]);
	}
	...
	public void putData(double[] data, double[] idata) {
		if (data != null)  putDataM(data, idata);
	}
	...
	public CSRMatrix multiply(CSRMatrix T) {
		...
		// over the other matrix, any corresponding values found covered by the stretch of a non-zero value are multiplied
